		...
		try {
			...
			try {
				...
				if (source === "startup") {
					...
					if (link === void 0) throw new Error(`agent-codex: session "${id}" has no codex/thread-linked event`);
...
//#endregion
export { CodexAgent, CodexAppServerWire, CodexThreadId, Config, apply, apply as default, inject, name };
